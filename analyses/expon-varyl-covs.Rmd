...
covs <- expfit_varyl_res %>% 
         mutate(covs_complete=map(res, process_covs, remove_fixed=FALSE)) %>%
         unnest(covs) %>% 
...
usethis::use_data(pd5f, overwrite=TRUE)
usethis::use_data(predf, overwrite=TRUE)
...
usethis::use_data(pd13f, overwrite=TRUE)
usethis::use_data(pred13f, overwrite=TRUE)
...
usethis::use_data(vark_types, overwrite=TRUE)
...
usethis::use_data(predf_ssh, overwrite=TRUE)
usethis::use_data(pd5f_ssh, overwrite=TRUE)
...
usethis::use_data(predf_ssh2, overwrite=TRUE)
usethis::use_data(pd5f_ssh2, overwrite=TRUE)
...
usethis::use_data(cumcov_plot_df, overwrite=TRUE)

write_tsv(pred_covs_all, '../data/cumcov_all.tsv')
usethis::use_data(cumcov_plot_all_df, overwrite=TRUE)

# unfiltered version
usethis::use_data(cumcov_plot_all_nofilt_df, overwrite=TRUE)
...
usethis::use_data(pd5_vard, overwrite=TRUE)
...
This is done on the population frequencies; see the R markdown file
`expon-varyl-mom.Rmd` for the analyses with sampling noise added.
...
usethis::use_data(mom_fitsd, overwrite=TRUE)
...
usethis::use_data(mom_fits_g, overwrite=TRUE)
...
usethis::use_data(mom_fits_gp, overwrite=TRUE)
