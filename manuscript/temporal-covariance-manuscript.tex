...
population, a third source of stochasticity affects allele frequency change:
random associations form between neutral alleles and the fitness of their
genetic backgrounds. As heritable fitness differences lead individuals to leave
differing numbers of offspring, the neutral alleles randomly associated with
these individuals are dragged along. Overall, the random associations with
heritable fitness backgrounds acts as a 



random chance associations form between neutral alleles and the genetic
background they happen to reside on. Since heritable fitness differences
between individuals act to further increase 
