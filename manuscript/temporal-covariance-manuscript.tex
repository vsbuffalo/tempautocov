...
necessary when using sampled, rather than population, allele frequencies; we
assume population frequencies are known throughout to simplify the explanation
of our method.} Sums over missing values only use pairwise-complete
observations, implemented by R's \texttt{cov()} function's
\texttt{use='pairwise.complete'} argument.
