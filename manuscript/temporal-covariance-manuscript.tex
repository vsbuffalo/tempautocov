...
Additionally, we can consider the impact that other \gc{unlinked} selected
...
\vb{where $g^*$ is the map distance at which a selected site becomes
...
\vb{As a simple thought experiment, } we might ask for what value of $M$ does
